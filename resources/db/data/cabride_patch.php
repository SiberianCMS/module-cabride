...
// Patching pre-SCA vaults!
$isScaReady = __get("carbide_sca_fix");
if ($isScaReady !== "done") {
    $query = "UPDATE cabride_client_vault SET is_removed = 1 WHERE card_token LIKE 'card_%';";
    try {
        $this->query($query);
    } catch (\Exception $e) {
        // Silently fails!
