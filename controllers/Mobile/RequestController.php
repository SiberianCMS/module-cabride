    ...
    public function rideAction()
    {
        try {
            ...
            foreach ($drivers as $driver) {
                ...
                if (!$_tmpDriver || !$_tmpDriver->getId()) {
                    throw new Exception(p__('cabride',
                        "Sorry, this driver doesn't exists."));
                }
                ...
                if (!array_key_exists($vehicleId, $collection)) {
                    ...
                    if (!$vehicle || !$vehicle->getId()) {
                        throw new Exception(p__('cabride',
                            "Sorry, this vehicle doesn't exists."));
                    }
    ...
    public function fetchAction ()
    {
        try {
            ...
            if ($data['payment_type'] === 'credit-card') {
                ...
                // @todo replace with the new payments
                $data['vault'] = [];
                $data['cash'] = false;
            } else {
                $data['cash'] = true;
